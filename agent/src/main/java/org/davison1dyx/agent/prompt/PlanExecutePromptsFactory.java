package org.davison1dyx.agent.prompt;
...
public class PlanExecutePromptsFactory {
    ...
    public static PlanExecutePromptsFactory buildPrompts() {
        return PlanExecutePromptsFactory.builder()
                .planPrompt(DefaultPrompt.PLAN)
                .executePrompt(DefaultPrompt.EXECUTE)
                .critiquePrompt(DefaultPrompt.CRITIQUE)
                .compressPrompt(DefaultPrompt.COMPRESS)
                .summarizePrompt(DefaultPrompt.SUMMARIZE)
                .build();
    }
